...
import aula08.Ex02.Pratos.*;
import aula08.Ex02.NotVegetarianos.*;
import aula08.Ex02.Vegetarianos.*;
...
public class A08E02 {
	...
	public static Alimento randAlimento() {
		...
		case 0:
			res = new Carne(CarneType.FRANGO, 22.3, 345.3, 300);
			break;
		case 1:
			res = new Peixe(PeixeType.CONGELADO, 31.3, 25.3, 200);
			break;
		case 2:
